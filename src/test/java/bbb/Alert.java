...
public class Alert {
	...
	public AndroidTouchAction actions;
	    ...
	    public void Alert_test() {
	        ...
	        AndroidElement okorcancel= (AndroidElement) driver.findElementByAccessibilityId("OK Cancel dialog with a message");
	        actions.tap(ElementOption.element(okorcancel)).perform();
